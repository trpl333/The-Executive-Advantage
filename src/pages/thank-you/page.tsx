  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0F2233] to-[#133044] flex flex-col items-center justify-center px-6 py-20">
      ...
      >
        ...
        >
          <i className="ri-checkbox-circle-line text-2xl" style={{ color: '#7EC8E3' }}></i>
        </div>
        ...
        <p className="text-sm text-white/60 leading-relaxed max-w-sm mx-auto mb-10">
          Here’s your download. If you want, reply with your biggest execution bottleneck and I’ll tell you the first workflow I’d build and the metric I’d track.
        </p>

        {/* CTAs */}
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a
            href="https://YOURDOMAIN.com/executive-advantage.pdf"
            target="_blank"
